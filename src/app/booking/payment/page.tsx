...
import { ChevronLeft, ChevronRight, CreditCard, Calendar, Shield, Lock } from 'lucide-react';
...
const PaymentPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // Redirect if no booking data, car selection, or user
    if (!data.from || !data.to || !data.date || !data.time || !data.selectedCar || !data.user) {
      router.push('/');
    }
  }, [router]);
    ...
    <div className="min-h-screen bg-black text-white">
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex justify-between items-center">
            <div className="flex space-x-8">
              ...
              <div className="flex items-center">
                <div className="w-8 h-8 bg-yellow-400 rounded-full flex items-center justify-center text-sm font-bold text-black">4</div>
                <span className="ml-2 text-sm text-yellow-400">Payment</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          {/* Booking Summary */}
          <div className="bg-gray-900 rounded-xl p-8">
            <h2 className="text-xl font-semibold mb-6 text-yellow-400">Booking Summary</h2>
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-between">
                ...
                <span className="text-right">{bookingData.from} → {bookingData.to}</span>
              </div>
