...
export default function Header() {
  ...
  return (
    <>
      <header className="bg-primary border-b border-rose-100 sticky top-0 z-40">
          ...
          <div className="flex justify-between items-center py-4">
            ...
            <div>
              ...
              <button
                ...
                className="cursor-pointer bg-[#ffffff] hover:bg-[#ffd9d9] text-[#7A1314] px-6 py-2 rounded-full transition-all duration-300 shadow-lg hover:shadow-xl"
              >
                Get Quote
              </button>
            </div>
